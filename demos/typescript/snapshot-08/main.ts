...
// IMPORTANT: import paths use `.js`, NOT `.ts`, even though we're
// writing TypeScript. The compiler emits these paths verbatim; Node's
// ESM loader requires the actual runtime filename, which is `.js`.

// 1. Importing a TYPE — name in curly braces.
