...
export default function App() {
  ...
  // The selected todo's assignee — the input to the dependent query.
  // null when nothing is selected (or the selected todo was deleted).
  const assigneeId =
        ...
        {isError && (
          <div className="py-4 text-center">
            ...
            <button
              onClick={() => refetch()}
              disabled={isFetching}
              className="text-sm px-4 py-2 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors"
            >
