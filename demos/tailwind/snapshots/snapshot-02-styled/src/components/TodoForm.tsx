  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 flex gap-2">
      ...
      <input
        ...
        className="w-16 px-2 py-2 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent tabular-nums"
      />
      <button
        type="submit"
        disabled={isEmpty}
